...
public enum RetCode {
    ...
    ERR_APPID_NULL("24","appId为空"),
    ERR_ACCESS_TOKEN_NULL("25","accessToken为空"),
    ERR_JWT_INVALID("26","Authorization校验错误"),
    ...
    ERR_SERVICE_NOT_FOUND("400","服务不存在"),
    ERR_INTERNAL_SERVER_ERROR("500","系统异常"),
    ERR_SERVICE_RESPONSE("510","服务响应异常");
